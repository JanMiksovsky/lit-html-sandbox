...
var Base = (0, _AttributeMarshallingMixin2.default)(
// ChildrenContentMixin(
(0, _LitHtmlMixin2.default)((0, _ReactiveMixin2.default)(HTMLElement)));
...
var TestElement = function (_Base) {
  ...
  _createClass(TestElement, [{
    ...
    get: function get() {
      ...
      var template = (0, _litHtml.html)(_templateObject, this.state.children, this.punctuation);
      return template;
    }
  }]);
...
var renderingKey = Symbol('renderingKey');
    ...
    _createClass(LitHtml, [{
      ...
      value: function appendChild(child) {
        if (this[renderingKey]) {
          _get(LitHtml.prototype.__proto__ || Object.getPrototypeOf(LitHtml.prototype), 'appendChild', this).call(this, child);
        } else {
      ...
      value: function render() {
        ...
        if (!this[initializedKey]) {
          ...
          var children = extractContent(this);
          if (children) {
            this.setState({ children: children });
            return;
          }
      ...
      key: 'defaultState',
      get: function get() {
        return Object.assign({}, _get(LitHtml.prototype.__proto__ || Object.getPrototypeOf(LitHtml.prototype), 'defaultState', this), {
          children: []
        });
      }
    }, {
      ...
      get: function get() {
        if (this[renderingKey]) {
          return _get(LitHtml.prototype.__proto__ || Object.getPrototypeOf(LitHtml.prototype), 'innerHTML', this);
        } else {
      ...
      set: function set(html) {
        if (this[renderingKey]) {
          _set(LitHtml.prototype.__proto__ || Object.getPrototypeOf(LitHtml.prototype), 'innerHTML', html, this);
        } else {
      ...
      get: function get() {
        if (this[renderingKey]) {
          return _get(LitHtml.prototype.__proto__ || Object.getPrototypeOf(LitHtml.prototype), 'textContent', this);
        } else {
          var strings = this.state.children.map(function (o) {
      ...
      set: function set(textContent) {
        if (this[renderingKey]) {
          _set(LitHtml.prototype.__proto__ || Object.getPrototypeOf(LitHtml.prototype), 'textContent', textContent, this);
        } else {
